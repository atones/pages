...
<main class="relative h-full w-full overflow-y-auto bg-white dark:bg-gray-800">
  <div class="p-4">
    ...
    <Toolbar class="w-full py-4 text-gray-500 dark:text-gray-400" embedded>
      <Input class="me-6 w-80 border xl:w-96" placeholder="Search for products" />
      <ToolbarButton
...
<Drawer bind:hidden placement="right" {transitionParams} transitionType="fly">
  <svelte:component bind:hidden this={drawerComponent} />
</Drawer>
